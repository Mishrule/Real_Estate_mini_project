        ...
        <?php require_once('inc/nav.php'); ?>
            ...
            <div class="main-content container-fluid">
                <div class="page-title">
                    <h3>View Agent</h3>
                    <p class="text-subtitle text-muted">View a single Agent</p>
                </div>
                    ...
                    <div class="row" id="table-head">
                        <div class="col-4">
                            ...
                            if (isset($_GET['agentid'])) {
                                $agentID = intVal(mysqli_real_escape_string($con, $_GET['agentid']));

                                $retrieveAgentSQL = "SELECT * from agent WHERE agentid = $agentID;
                                                         ";
                                        ...
                                        echo '
                                            <div class="card">
                                                <div class="card-content">
                                                    <img src="assets/images/' . $retrieveAgentRow['agentimage'] . '" class="d-block w-100" alt="Agent Name">
                                                        <div class="card-body">
                                                            <h5 class="card-title">' . $retrieveAgentRow['agentname'] . '</h5>
                                                                <p class="card-text">
                                                                            ' . $retrieveAgentRow['agentbio'] . '
                                                                </p>
                                                        </div>
                                                </div>
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><strong>Agent Location:</strong> ' . $retrieveAgentRow['agentlocation'] . '</li>
                                                    <li class="list-group-item"><strong>Agent Contact:</strong> ' . $retrieveAgentRow['agentcontact'] . '</li>
                                                    <li class="list-group-item"><strong>Agent Email:</strong> ' . $retrieveAgentRow['agentemail'] . '</li>
                                                    <li class="list-group-item"><strong>Created Date:</strong> ' . $retrieveAgentRow['createddate'] . '</li>
                                                ...
                                                <button type="button" class="btn btn-primary round me-1 edit" id="' . $retrieveAgentRow['agentid'] . '" name="' . $retrieveAgentRow['agentid'] . '"  data-bs-toggle="modal" data-bs-target="#primary">Update</button>

                                                <button type="button" id="' . $retrieveAgentRow['agentid'] . '" name="' . $retrieveAgentRow['agentid'] . '" class="btn btn-danger round del">Delete</button><br />
                                            </div>
                                            </div>

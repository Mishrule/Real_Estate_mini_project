                                                    ...
                                                    if(mysqli_num_rows($retrievePropResult) > 0){
                                                        while($retrievePropRow = mysqli_fetch_array($retrievePropResult)){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>'.$retrievePropRow['propamountcharged'].'</td>
                                                                <td>'.$retrievePropRow['propstatus'].'</td>
                                                                <td>
                                                                    <i style="color:blue;" data-feather="edit" id="'.$retrievePropRow['propid'].'" name="'.$retrievePropRow['propid'].'"></i>
                                                                    <i ></i>
                                                                    <i style="color:red;" data-feather="trash" id="'.$retrievePropRow['propid'].'" name="'.$retrievePropRow['propid'].'"></i>
                                                                </td>
                                                            </tr>
                                                            ';
                                                            $count++;
                                                        ...
                                                        echo '
                                                        <tr>
                                                            <td colspan="10" class="text-bold-500">Michael Right</td>
                                                        </tr>
                                                        ';
                                                    }
                                                ?>
